...
const About = () => {
    const downlaodPdf = ()=>{
        const pdfPath = '/MOHAMED_ZEROUALI_CV_FRENCH.pdf'
        const link = document.createElement('a')
        link.href = pdfPath
        link.setAttribute('download','mohamed_zerouali_cv.pdf')
        link.click()
    }
    ...
    return (
        ...
        <motion.div
            ...
            <div className='space-y-10 md:px-10 px-0'>
                ...
                <button className='bg-main-color font-semibold text-black px-2 py-3 rounded-md' onClick={downlaodPdf}>Download CV</button>
            </div>
        </motion.div>
  )
}
